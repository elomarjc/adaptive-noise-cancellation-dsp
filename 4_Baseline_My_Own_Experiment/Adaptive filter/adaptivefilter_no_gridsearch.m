...
% [u, fs] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\NHS data\baby crying\48000 hz\Primary.wav");  % Primary - Noisy signal with heartbeat   
% [d, ~] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\NHS data\baby crying\48000 hz\Secondary.wav"); % Reference noise signal     

% [u, fs] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\NHS New Data - AdaptiveFilter\Ambulance&Traffic\Primary.wav");   %noise + clean signal
% [d, ~] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\NHS New Data - AdaptiveFilter\Ambulance&Traffic\Secondary.wav");

[u, fs] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\Adaptive filter\NHS New Data - AdaptiveFilter\ambient noise\Primary.wav");   %noise + clean signal
[d, ~] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\Adaptive filter\NHS New Data - AdaptiveFilter\ambient noise\Secondary.wav");
[x, ~] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\Adaptive filter\NHS New Data - AdaptiveFilter\ambient noise\Clean.wav");

% Name of audio type to have in figures and folder name
suffix = 'ambient noise no grid search';
